...
// Папка с SVG
const inputDir = path.resolve(__dirname, '../resources/images/source');
// Куда сохранить спрайт
const outputWebp = path.resolve(__dirname, '../resources/images/webp');
...
if (!filesToUpdate.length) {
  console.log(
    chalk.yellow('Конвертировать нечего — все файлы уже в актуальном формате!'),
  );
  process.exit();
}

console.log(
  chalk.cyan(`Нужно конвертировать ${filesToUpdate.length} файлов:\n`),
);
