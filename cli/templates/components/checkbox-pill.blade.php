...
@php
    ...
    $checkedColors = [
        ...
        // Дополнительные цвета (оставляем Tailwind, так как для них нет отдельных переменных)
    ...
    $pillClasses = cn(
        ...
        'peer-not-checked:hover:bg-accent peer-not-checked:hover:border-input/50',
